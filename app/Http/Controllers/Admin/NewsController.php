...
class NewsController extends BaseController
{
    ...
    */
    ...
    public function __construct(News $model)
    {
        ...
        $this->model = $model;
        $this->routes_suffix = 'News';
        $this->views_folder = 'Administrator.newses.news';
        $this->main_table = 'news';
        $this->translates_table = 'news_translates';
        $this->categories_model = 'App\Models\NewsCategories';
    }
