...
class DoctorController extends BaseController
{
    ...
    */
    ...
    public function __construct(Doctor $model)
    {
        ...
        $this->model = $model;
        $this->routes_suffix = 'Doctors';
        $this->views_folder = 'Administrator.doctors';
        $this->main_table = 'doctors';
        $this->translates_table = 'doctor_translates';
    }
    ...
    protected $required_columns = ['image', 'full_name', 'specialty', 'education', 'experience'];

    public function index(): View
    {
        $this->data['listing_columns'] = ['sort', 'status', 'image', 'full_name', 'specialty']; // <th> ელემენტები
    ...
    public function store(Request $request): RedirectResponse
    {
        $this->validate($request, [
            ...
            'translates.'.$this->configuration->admin_lang.'.experience' => 'required',
