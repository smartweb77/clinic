                        ...
                        >
                            @isset($translate_columns)
                                @forelse($translate_columns as $translate_column)
                                    @if($translate_column === 'experience')
                                        <div class="form-group not-need {{ $errors->has('translates.'.$lang['prefix'].'.experience') ? 'bad' : '' }}">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">
                                            ...
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                <textarea name="translates[{{ $lang['prefix'] }}][experience]"  
                                                id="editor_{{ $lang["prefix"] }}" 
                                                          class="form-control col-md-7 col-xs-12" 
                                                >{{ old('translates.'.$lang['prefix'].'.experience') }}</textarea>
                                            </div>
                                        </div>
                                    @elseif($translate_column === 'education')
                                        <div class="form-group not-need {{ $errors->has('translates.'.$lang['prefix'].'.education') ? 'bad' : '' }}">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">
                                                @lang('admin.' . $translate_column) 
                                                @if(in_array($translate_column,$required_columns))
                                                    <span class="required">*</span>
                                            ...
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                <textarea name="translates[{{ $lang['prefix'] }}][education]"  
                                                          class="form-control col-md-7 col-xs-12" 
                                                          id="short_description_{{ $lang["prefix"] }}" 
                                                >{{ old('translates.'.$lang['prefix'].'.education') }}</textarea>
                                            </div>
                                        </div>
                                    @else
