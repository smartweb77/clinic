                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <li>
                                        <a href="{{ route('Services') }}" title="@lang('admin.routes.Services')">
                                            <i class="khvich-i fas fa-wrench"></i>
                                            <span class="menu-text">@lang('admin.routes.Services')</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('Doctors') }}" title="@lang('admin.routes.Doctors')">
                                            <i class="khvich-i fas fa-ambulance"></i>
                                            <span class="menu-text">@lang('admin.routes.Doctors')</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('News') }}" title="@lang('admin.routes.News')">
                                            <i class="khvich-i fas fa-newspaper"></i>
                                            <span class="menu-text">@lang('admin.routes.News')</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('EditHistories') }}" title="@lang('admin.routes.Histories')">
                                            <i class="khvich-i fas fa-history"></i>
                                            <span class="menu-text">@lang('admin.routes.Histories')</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('Messages') }}" title="@lang('admin.routes.Messages')">
                                            <i class="khvich-i fas fa-comment"></i>
